...
async function fetchMetaData(movieTitle) {
  let pagesRequired = 0;
  axios
    .get(`${omdbURL}${keys.omdbKey}&s=${movieTitle}&type=movie`)
    .then(movies => {
